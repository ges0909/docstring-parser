...
def test_numpy_style_docstring_parser(benchmark):
    ...
    doc = benchmark(parse, text=test_numpy_style_docstring_parser.__doc__)
    ...
    assert (
        description == "Examples should be written in doctest format, and should illustrate how to use the function."
...
def test_google_style_docstring_parser(benchmark):
    ...
    doc = benchmark(parse, text=test_google_style_docstring_parser.__doc__)
    assert doc.short_description == "Summary line."
    assert doc.long_description == 'Extended description of function.\nThe alias of the function is "blablabla".'
